...
Route::middleware(['auth', 'IsAdmin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::delete('/admin/siswa/delete-selected', [SiswaController::class, 'deleteSelected'])->name('siswa.deleteSelected');
    Route::post('/admin/settings/store', [AdminController::class, 'storeAdmin'])->name('admin.settings.store');
    ...
    Route::resource('jadwal', JadwalController::class)->names([
        ...
        'store' => 'jadwal.store',
        'getGuruData' => 'jadwal.getGuruData',
        'edit' => 'jadwal.edit',
