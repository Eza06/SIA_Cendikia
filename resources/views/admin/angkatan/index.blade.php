                ...
                <div class="card">
                    <div class="card-header d-xl-block">
                        <div class="d-xl-flex align-items-center mb-4 d-block">
                            {{-- <a href="#" class="btn btn-warning me-2 tambahMapelBtn"
                                data-id="" data-name=""
                            ...
                            <a href="#" class="btn btn-primary d-flex align-items-center me-2 tambahMapelBtn"
                                data-id="" data-name="" data-bs-toggle="modal" data-bs-target="#tambahAngkatanModal">
                                <i class='bx bx-add-to-queue me-1'></i> Tambah Tahun Ajaran</a>
                            <!-- Edit Mapel Modal -->
                                    ...
                                    <form action="{{ route('admin.angkatan.store') }}" method="POST">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="tambahAngkatanModalLabel">Tambah Tahun Ajaran
                                                </h5>
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group mb-3">
                                                    <label for="edit_mapel_name">Tahun Ajaran</label>
                                                    <!-- Form Tambah Tahun Ajaran -->
                                                    <input type="text" name="tahun_angkatan"
                                                        id="input_tambah_tahun_angkatan" class="form-control" required>
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    <a href="#" class="btn btn-warning me-2 editMapelBtn"
                                                        data-id="{{ $angkatan->id }}"
                                                        data-name="{{ $angkatan->tahun_angkatan }}" data-bs-toggle="modal"
                                                    ...
                                                    <div class="modal fade" id="editMapelModal" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <form action="{{ route('admin.angkatan.update', $angkatan->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="form-group mb-3">
                                                                            <label for="edit_mapel_name">Tahun
                                                                                Ajaran</label>
                                                                            <input type="text" name="tahun_angkatan"
