...
<div class="layout-page">
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
                                ...
                                @foreach ($kelasBelajar as $index => $kelas)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <form action="{{ route('admin.kelasbelajar.destroy', $kelas->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                    ...
                    <form action="{{ route('admin.kelasbelajar.store') }}" method="POST">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Tambah Kelas Belajar</h5>
            ...
            <!-- Modal Edit Kelas (satu kali saja) -->
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.querySelectorAll('.editMapelBtn').forEach(button => {
            button.addEventListener('click', function () {
                const id = this.getAttribute('data-id');
                const name = this.getAttribute('data-name');
                document.getElementById('edit_mapel_name').value = name;
                document.getElementById('editKelasForm').action = `/admin/kelasbelajar/${id}`;
            });
        });
    });
</script>
