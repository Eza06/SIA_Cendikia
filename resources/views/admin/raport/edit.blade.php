        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.raport.update', $rapor->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_rapor" id="nama_rapor" class="form-control"
                                    value="{{ old('nama_rapor', $rapor->nama_rapor) }}" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="kelas_belajar_id" id="kelas_belajar_id" class="form-control" required>
                            ...
                            @if (count($siswas) > 0)
                                <h5 class="mt-4">Edit Nilai Siswa</h5>
                                <div class="row mt-3">
                            ...
                            <button type="submit" class="btn btn-primary">Update Raport</button>
                            <a href="{{ route('admin.raport.index') }}" class="btn btn-secondary">Batal</a>
                        </form>
                    </div>
                </div>
            </div>
