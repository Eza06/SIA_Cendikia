                    ...
                    <div class="card-header d-xl-block">
                        <div class="d-xl-flex align-items-center mb-4 d-block">
                            ...
                            <a href="#" class="btn btn-primary d-flex align-items-center me-2 tambahMapelBtn"
                                ...
                                <i class='bx bx-add-to-queue me-1'></i> Tambah Mapel</a>
                            <!-- Edit Mapel Modal -->
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group mb-3">
                                                            <label for="edit_mapel_name">Nama Mapel</label>
                                                            <input type="text" name="name" id="edit_mapel_name" class="form-control" required>
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    <a href="#" class="btn btn-warning me-2 editMapelBtn"
                                                        data-id="{{ $mapels->id }}" data-name="{{ $mapels->name }}"
                                                    ...
                                                    <div class="modal fade" id="editMapelModal" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <form action="{{ route('admin.mapel.update', $mapels->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('admin.mapel.destroy', $mapels->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
