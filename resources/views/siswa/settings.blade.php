...
<div class="layout-page">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card mb-4">
                <div class="card-body d-flex align-items-center">
                    <div class="d-flex flex-column w-100">
                        <div><strong>KODE SISWA : </strong> {{ Auth::user()->siswa->kode_siswa ?? '-' }}</div>
                        <hr>
            ...
            <!-- Form Ubah Data -->
            <h4 class="fw-bold py-3">Ubah Informasi Siswa</h4>
                ...
                <div class="card-body">
                    <form action="{{ route('siswa.settings.update') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="no_telpon" class="form-control" value="{{ old('no_telpon', $user->siswa->no_telpon ?? ' - ') }}">
                        </div>
                    
                        <div class="mb-3">
                            <label class="form-label">Alamat</label>
                            <textarea name="alamat" class="form-control">{{ old('alamat', $user->siswa->alamat ?? '') }}</textarea>
                        </div>
